...
export const ResizableImage: React.FC<ResizableImageProps> = ({
    ...
    const windowMouseMoveHandler = React.useCallback(
        (event: MouseEvent): void => {
            ...
            if (align === "center") {
                ...
                if (resizeParams.handleUsed === "left") {
                    newWidth =
                        resizeParams.initialWidth + resizeParams.initialClientX - event.clientX;
                } else {
                    newWidth =
                        resizeParams.initialWidth + event.clientX - resizeParams.initialClientX;
                }
            }
    ...
    const leftResizeHandleMouseDownHandler = (event: React.MouseEvent<HTMLDivElement>): void => {
    ...
    const rightResizeHandleMouseDownHandler = (event: React.MouseEvent<HTMLDivElement>): void => {
        event.preventDefault();
    ...
    const wrapperMouseLeaveHandler = (event: React.MouseEvent<HTMLDivElement>): void => {
        if (
