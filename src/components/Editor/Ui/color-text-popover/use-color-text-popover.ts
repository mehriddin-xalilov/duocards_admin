...
// --- Icons ---
import { TextColorSmallIcon } from "@/components/Editor/Icons/text-color-small-icon";

// --- Lib ---
import { isMarkInSchema } from "@/components/Editor/lib/utils/tiptap-utils";
import { getActiveMarkAttrs } from "@/components/Editor/lib/utils/tiptap-advanced-utils";

// --- Tiptap UI ---
import { canColorText } from "@/components/Editor/Ui/color-text-button";
import { canColorHighlight } from "@/components/Editor/Ui/color-highlight-button";
