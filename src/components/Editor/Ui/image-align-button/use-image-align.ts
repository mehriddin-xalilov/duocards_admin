...
// --- Lib ---
import { isExtensionAvailable } from "@/components/Editor/lib/utils/tiptap-utils";

// --- Icons ---
import { AlignCenterVerticalIcon } from "@/components/Editor/Icons/align-center-vertical-icon";
import { AlignEndVerticalIcon } from "@/components/Editor/Icons/align-end-vertical-icon";
import { AlignStartVerticalIcon } from "@/components/Editor/Icons/align-start-vertical-icon";
...
export function setImageAlign(
    ...
    if (!editor || !editor.isEditable) return false;
    if (!isExtensionAvailable(editor, [extensionName])) return false;
    if (!canSetImageAlign(editor, align, extensionName, attributeName)) return false;
